...
Forbidden Keywords for the Quiz: eval, sort, open, file, creat(, fstream, thread, process, system(, exec(
...
Input
The first line will contain a number T(1≤T≤1000)
...
, your answer will still be considered correct. As long as it is really close to the correct solution, your solution will be considered correct. Formally speaking, if your solution is x
, and the judge's solution is y
, then as long as |x−y|≤10−6
